...
- 마스터 계획서: docs/plans/2026-04-14-official-form-alignment.md (12 Step / 150 Task)
...
5. ls docs/plans/2026-04-14-official-form-alignment.md  → 계획서 파일 존재 확인
...
> 계획서 해당 섹션의 정확한 줄 위치는 `grep -n '^## 0\.' docs/plans/2026-04-14-official-form-alignment.md` 같은 명령으로 헤더 위치 재확인 후 Read offset 지정.
...
3가지 모두 OK면 다음 세션: docs/prompts/session-02-step2-db-foundation.md
────────────────────────────────────────
```

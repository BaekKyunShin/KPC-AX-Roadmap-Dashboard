...
4. **플레이스홀더 전수 매핑 표 작성** — 계획서(`docs/plans/archive/2026-04-24-interview-result-screens-redesign.md`) 안에 아래 형식의 **완전한 매핑 표**를 포함한다.
...
2. **`superpowers:writing-plans`** — **PlanMode 진입** 후 `docs/plans/archive/2026-04-24-interview-result-screens-redesign.md` 계획서를 작성하고 사용자 승인 대기
...
3. `superpowers:writing-plans` 스킬을 따라 **`docs/plans/archive/2026-04-24-interview-result-screens-redesign.md`** 계획서를 작성한다. 계획서에는 아래가 반드시 포함되어야 한다.

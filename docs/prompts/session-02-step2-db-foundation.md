...
6. ls docs/plans/2026-04-14-official-form-alignment.md      → 계획서 존재
...
=== 필수 사전 정독 ===
> 계획서 해당 섹션의 정확한 줄 위치는 `grep -n '^## 0\.\|^### 3-4\.\|^### Step 2:' docs/plans/2026-04-14-official-form-alignment.md` 로 헤더 줄 확인 후 Read offset 지정.

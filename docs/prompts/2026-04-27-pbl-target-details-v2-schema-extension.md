...
1. **PlanMode 진입 + 계획 작성** (`docs/plans/2026-04-27-pbl-target-details-v2-extension.md`)
...
3. PlanMode 로 Phase A~H 세분화 계획 작성 (`docs/plans/2026-04-27-pbl-target-details-v2-extension.md`)

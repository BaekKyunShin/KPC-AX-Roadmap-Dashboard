...
> **상태(2026-08-01):** 6건 중 **3건 완료** — `P5`(PR #135) · `P6`(PR #138) · `P8`(PR #154). 잔여 3건 중 `P7` 은 **1단계+분할안 B·C·D·E·F 완료**(PR #155·#156·#157·#158, 아래 진행 블록 참조 — 남은 것은 **단계 5**(F 예외 9파일, 동작 변경 경계 — 별도 설계+사용자 승인)와 lib→components 역전 1건(아래 옵션 기록)), `P9`·`P4` 미착수.

...
#### 3-4-6. 반응형·모바일
- 기존 프로젝트는 **모바일 반응형 Batch 0~6 완료**(`docs/plans/archive/2026-02-19-mobile-responsive-spec.md`). 신규 페이지·테이블은 해당 문서의 브레이크포인트(sm/md/lg) 규칙을 그대로 따른다.
...
**파일:**
- 신규: 본 계획서 (`docs/plans/archive/2026-04-14-official-form-alignment.md`)
...
```bash
git add docs/plans/archive/2026-04-14-official-form-alignment.md
...
- `docs/prompts/archive/session-00-overview.md`
- `docs/prompts/archive/session-01-step1-setup.md`
- `docs/prompts/archive/session-02-step2-db-foundation.md`
- `docs/prompts/archive/session-03-step3-4-parallel.md`
- `docs/prompts/archive/session-04-step5-roadmap-interview.md`
- `docs/prompts/archive/session-05-step6-roadmap-output.md`
- `docs/prompts/archive/session-05b-step6.5-form-compliance.md`
- `docs/prompts/archive/session-06-step7-roadmap-hwpx.md`
- `docs/prompts/archive/session-07-step8-pbl-interview.md`
- `docs/prompts/archive/session-08-step9-pbl-output.md`
- `docs/prompts/archive/session-09-step10-pbl-hwpx.md`
...
**참고 입력 문서:** Task 3.6 과 동일 13 문서 (마스터 계획서 §4 Step 1~11 각각 + `docs/prompts/archive/session-0{0..9}-*.md` + `session-05b-*.md` + `session-10-*.md`).

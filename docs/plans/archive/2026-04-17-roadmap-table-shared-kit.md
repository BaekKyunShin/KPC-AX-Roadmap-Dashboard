...
**Spec reference:** `docs/plans/archive/2026-04-16-roadmap-table-shared-kit-design.md`
...
컨설턴트 계정(`kpc@test.com` / `<비공개>`)으로 로그인 → 담당 프로젝트 → 로드맵 결과 페이지 열기 → 다음 확인:
...
운영관리자 계정(`son@test.com` / `<비공개>`)으로 로그인 → 운영관리 > 프로젝트 관리 → 특정 프로젝트 → 로드맵 탭에서 동일 표가 읽기 전용으로 정상 렌더되는지 확인.
...
- `docs/plans/archive/2026-04-16-roadmap-table-shared-kit-design.md`
- `docs/plans/archive/2026-04-17-roadmap-table-shared-kit.md`

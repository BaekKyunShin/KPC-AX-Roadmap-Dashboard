...
- **후보 작업**:
  ...
  - 린트 규칙 강화 검토
  - README/문서 업데이트
- [x] 완료 (Session 3-6: 매직 넘버 상수화 + 린트 규칙 강화)
- [x] 완료 (Session 3-7~8: JSDoc 정리 + ARCHITECTURE.md/CLAUDE.md 문서 업데이트)
...
| 3 | 3-4 | 타입 정리 | 완료 |
| 3 | 3-5 | 네이밍 일관성 | 완료 |
| 3 | 3-6 | 매직 넘버 상수화 + 린트 규칙 강화 | 완료 |
| 3 | 3-7~8 | JSDoc 정리 + 문서 업데이트 | 완료 |

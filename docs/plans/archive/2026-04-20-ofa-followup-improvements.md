...
- `docs/audit/2026-04-19-session11-security-audit.md` (보안 H-3 + M-4·M-5·M-6)
- `docs/audit/2026-04-19-session11-performance-audit.md` (성능 H-1·H-2)
...
- 계획서: docs/plans/archive/2026-04-20-ofa-followup-improvements.md (이 파일 정독)
...
=== 필수 정독 ===
1. docs/plans/archive/2026-04-20-ofa-followup-improvements.md — 본 계획서
2. docs/audit/2026-04-19-session11-security-audit.md
3. docs/audit/2026-04-19-session11-performance-audit.md

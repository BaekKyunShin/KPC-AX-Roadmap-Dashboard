...
## 참고 문서
- 계획서: docs/plans/2026-02-20-mobile-responsive-v2-spec.md
- 1차 계획서: docs/plans/2026-02-19-mobile-responsive-spec.md
...
3. 변경 로그(`docs/2026-02-19-mobile-responsive-changelog.md`) 업데이트
4. 커밋 생성

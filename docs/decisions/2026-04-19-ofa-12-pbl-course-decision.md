...
계획서(`docs/plans/archive/2026-04-14-official-form-alignment.md` §4 Step 12)는 Session 09 시점의 코드 실측에 근거해 `pbl_course` 컬럼을 레거시 잔존물로 간주하고 DROP COLUMN 을 지시했다.
...
- `docs/plans/archive/2026-04-14-official-form-alignment.md` §4 Step 12 Task 2

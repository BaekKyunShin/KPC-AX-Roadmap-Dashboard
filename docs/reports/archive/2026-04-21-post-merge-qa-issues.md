...
**참조 계획서**: `docs/plans/archive/2026-04-20-ofa-post-merge-deployment.md` §4 + §5
**스모크 리포트**: `docs/reports/2026-04-21-prod-smoke-report.md`
...
|------|---------|--------|-------------|------|
| 🔴 Batch 1 | ISSUE-04·06·07·19 (Critical/High 4건 — LLM/스키마) | `fix/batch-1-llm-and-schema` | `docs/prompts/archive/2026-04-22-batch-1-llm-schema.md` | ✅ 머지 (PR #18, main `134fb25`, 2026-04-22) |
...
| 🟡 Batch 2 | ISSUE-01·02·03·05·08~18·**20** (UI/UX 16건) | `fix/batch-2-ui-ux` | `docs/prompts/archive/2026-04-22-batch-2-ui-ux.md` | ⏳ 대기 |

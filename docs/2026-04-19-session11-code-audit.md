...
- **참고**: `docs/plans/2026-04-14-official-form-alignment.md` + `docs/prompts/session-*.md` 13개
...
|---|---|---|---|---|
| 1 | 01 | 메인 브랜치 생성, 계획서 커밋, hwpx-docgen 스킬 설치 | `docs/plans/2026-04-14-official-form-alignment.md` · `.claude/skills/hwpx-docgen/` | 기록상 머지 완료 (확인 불가) |

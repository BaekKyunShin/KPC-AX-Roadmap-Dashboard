...
/**
 * Supabase interviews 행의 JSONB 컬럼을 InterviewSummaryProps로 변환
 */
export function toInterviewSummaryProps(interview: {
  ...
  return {
    companyDetails: (interview.company_details as CompanyDetailsData | null) ?? null,
    jobTasks: (interview.job_tasks as JobTaskData[]) ?? [],
    painPoints: (interview.pain_points as PainPointData[]) ?? [],
    improvementGoals: (interview.improvement_goals as ImprovementGoalData[]) ?? [],
    constraints: (interview.constraints as ConstraintData[]) ?? [],

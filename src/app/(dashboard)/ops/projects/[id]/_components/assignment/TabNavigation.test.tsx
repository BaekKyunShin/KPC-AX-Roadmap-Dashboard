...
describe('TabNavigation', () => {
  ...
  describe('탭 렌더링', () => {
    it('tabs 배열의 모든 탭이 렌더링된다', () => {
      render(<TabNavigation activeTab="auto" onTabChange={mockOnTabChange} tabs={defaultTabs} />);
    ...
    it('단일 탭도 올바르게 렌더링된다', () => {
      ...
      render(<TabNavigation activeTab="auto" onTabChange={mockOnTabChange} tabs={singleTab} />);
  ...
  describe('활성 탭 스타일', () => {
    ...
    it('manual 탭이 활성화되면 manual 버튼에 border-blue-500이 포함된다', () => {
      render(<TabNavigation activeTab="manual" onTabChange={mockOnTabChange} tabs={defaultTabs} />);
      const manualButton = screen.getByText('직접 선택').closest('button');
  ...
  describe('뱃지 숫자', () => {
    ...
    it('badge=5인 경우 "5명"이 표시된다', () => {
      ...
      render(<TabNavigation activeTab="auto" onTabChange={mockOnTabChange} tabs={tabs} />);

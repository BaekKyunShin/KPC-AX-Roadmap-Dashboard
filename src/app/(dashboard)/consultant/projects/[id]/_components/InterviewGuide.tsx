...
import { RefreshCw, FileDown, Loader2, Sparkles } from 'lucide-react';
...
export function InterviewGuide({
  ...
  if (isGenerating) {
    return (
      <div className="flex flex-col items-center justify-center rounded-lg border bg-white px-6 py-20">
        <Loader2 className="h-8 w-8 animate-spin text-purple-500" />
        <p className="mt-4 text-sm font-medium text-gray-700">AI가 진단 결과를 분석하고 있습니다...</p>
        <p className="mt-1 text-xs text-gray-400">약 10~20초 소요됩니다.</p>
      </div>
    );
  }

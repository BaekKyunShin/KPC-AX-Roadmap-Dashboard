...
describe('ROADMAP_ELIGIBLE_STATUSES', () => {
  it('INTERVIEWED, ROADMAP_DRAFTED, FINALIZED를 포함한다 (정식 확정 후에도 새 DRAFT 생성 가능 정책 고정)', () => {
    expect(ROADMAP_ELIGIBLE_STATUSES).toEqual(['INTERVIEWED', 'ROADMAP_DRAFTED', 'FINALIZED']);
  });
});

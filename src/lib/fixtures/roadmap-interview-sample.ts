 ...
 * Ⅰ~Ⅲ-1 전체 섹션이 채워진 제조업 사례 — LLM 이 양질의 로드맵 초안을 만들 수 있는
...
export const ROADMAP_INTERVIEW_SAMPLE: RoadmapInterviewStrict = {
  ...
  taskAnalysisNote:
    '인터뷰 과정에서 경영진·현장 모두 AI 도입 의지가 강한 것을 확인했다. IT 기획 담당자 1인이 전담하고 있어 외부 전문가(데이터 엔지니어) 지원이 필요. 차기 인터뷰(2차) 에서 ERP/MES 연계 구조 도식과 최근 12개월 불량 데이터 샘플을 공유하기로 함. HRD이음 진단 결과와 현장 관찰을 비교한 결과, 기초형 보다 실제 역량은 다소 낮은 편이라 기초 통계·데이터 리터러시 교육 비중을 확대할 필요가 있음.',

/**
 * @deprecated OFA-05에서 산인공 양식 정렬 작업으로 인터뷰 스키마가
 * `interview-roadmap.ts` / `interview-pbl.ts`(Step 8 예정)로 이전되었습니다.
 * 신규 코드는 트랙별 스키마를 사용하세요.
 * 이 파일은 OFA Step 12에서 의존성 정리 후 제거될 예정입니다.
 */
import { z } from 'zod';

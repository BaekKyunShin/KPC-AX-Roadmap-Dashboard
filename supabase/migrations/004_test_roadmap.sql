...
-- 테스트 케이스 인터뷰 생성: 본인이 생성한 테스트 케이스의 인터뷰
...
-- ============================================
-- 새로운 감사 액션:
-- - TEST_CASE_CREATE: 테스트 케이스 생성
-- - TEST_ROADMAP_CREATE: 테스트 로드맵 생성
-- - TEST_CASE_DELETE: 테스트 케이스 삭제
